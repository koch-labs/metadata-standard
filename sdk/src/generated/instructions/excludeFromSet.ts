...
export interface ExcludeFromSetAccounts {
  payer: PublicKey
...
export function excludeFromSet(
  accounts: ExcludeFromSetAccounts,
  ...
  const identifier = Buffer.from([155, 63, 131, 43, 217, 57, 25, 234])
